...
//        // Bind book information to UI components
...
//
//        // Set the ID as a tag to the item view
//        holder.itemView.setTag(bookInfo.getId());
//
//        holder.itemView.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                // Retrieve the ID from the clicked item
//                String bookId = (String) v.getTag();
//
//                // Start the BookDetails activity with the ID
